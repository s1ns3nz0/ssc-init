...
var immutableCatalog = []targetDeclaration{
	...
	{spec: targetSpec("mcp.codex.project", "codex", model.ScopeProject, "toml", model.TargetFile), relativePath: ".codex/config.toml", consumers: []string{"codex"}},
	{spec: targetSpec("mcp.codex.user", "codex", model.ScopeUser, "toml", model.TargetFile), relativePath: ".codex/config.toml", consumers: []string{"codex"}},
