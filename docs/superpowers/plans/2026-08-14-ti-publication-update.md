...
- [ ] **Step 1: Write failing coordinate and correlation tests**
...
- [ ] **Step 3: Implement strict identity parsing and correlation**
...
- [ ] **Step 1: Write failing normalization tests using literal fixtures**
...
- [ ] **Step 3: Implement a closed OSV subset and deterministic builder**
...
- [ ] **Step 4: Verify publisher behavior and reproducibility**
...
- [ ] **Step 1: Write failing manifest/trust tests**
...
- [ ] **Step 3: Implement closed manifest verification and trust seam**
...
- [ ] **Step 4: Verify GREEN and key-confusion mutations**
...
- [ ] **Step 1: Write failing updater lifecycle tests with a local TLS server**
...
- [ ] **Step 3: Implement the updater and closed transport**
...
- [ ] **Step 4: Verify GREEN, race, and security mutations**
...
- [ ] **Step 3: Implement parser, wiring, and audit receipt**
...
- [ ] **Step 4: Verify GREEN and branch mutations**
...
- [ ] **Step 1: Write failing golden/privacy tests**
...
- [ ] **Step 3: Implement action-first TI rendering**
...
- [ ] **Step 4: Verify GREEN and privacy mutations**
...
- [ ] **Step 1: Write failing workflow and isolated-HOME acceptance tests**
...
- [ ] **Step 3: Implement workflow and operator documentation**
...
- [ ] **Step 4: Verify all gates and real mutation battery**
...
- [ ] **Step 5: Commit implementation-complete state**
...
- [ ] **Step 6: Provision production trust and run real-release acceptance**
...
- [ ] **Step 7: Commit the production public key and evidence documentation**
